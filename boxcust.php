...
<div class="container">
<div class="single-grid wow fadeInLeft animated" data-wow-delay="0s">
<form action="dropcust.php" method="POST">
...
?>
	<div class="container">
			<div class="comment">
							 ...
							 <div class="media wow fadeInLeft animated" data-wow-delay="0s">
								<div class="code-in">
							    ...
							    <div class="media-left">
									...
									<?php  
											...
											if( $row['mfrom']==$mto){
												$s="select * from cust_reg where email='$mto'";
												...
												$s="select * from rest_reg where email='$mfrom'";
