				...
				<?php
					...
					while($row = mysqli_fetch_array($result)){
						if($_SESSION['email']==$row['email']){
							?>		
							<li>
                                <a href="cust_menu.php">Welcome,<?php echo ucfirst($row['email']); ?> </a>
                            </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="cust_order_view.php">See your orders</a>
                            </li>
                            <li>
                                <a href="#"></a>
                            </li>
					...
					<li>
                        <a href="inboxcust.php">View messages</a>
                    </li>
					
					
					</li> <a href="billing.php" class="btn btn-danger btn-lg">
