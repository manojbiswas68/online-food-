...
$name=$_SESSION['email'];
$id=$_GET['idx'];
$sql="select * from confirmed_order c inner join meals m on c.fid=m.ID inner join rest_reg r on m.rest_reg='$name' inner join address a on a.add_id=c.add_id and a.zip='$id' group by c.add_id;";
