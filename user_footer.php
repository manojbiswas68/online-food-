...
<!--footer-->
	<div class="footer">
		<div class="container">
			<div class="footer-head">
				<div class="col-md-8 footer-top animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
					<ul class=" in">
						...
						<li><a  href="inboxcust.php">Messages</a></li>
				...
				<div class="col-md-4 footer-bottom  animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					...
					<p>Food is All you Need</p><ul class="social-ic">
						<li><a href="#"><i></i></a></li>
			...
			<p class="footer-class animated wow bounce" data-wow-duration="1000ms" data-wow-delay="500ms"> All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">Manish   | Manoj    | Shubham</a> </p>
		</div>
	</div>		
	<!--//footer-->
